...
class DatabaseRunner():
    ...
    def insertData(self):
        db.session.add_all([
            ...
            User(username='admin', email='sciboard.org@gmail.com', first_name='admin', last_name='modson', password_hash=stdPwd,vertified=True),
            ...
            User(username='Jeff', email='stian.sls@gmail.com', first_name='Jeff', last_name='Bezos', password_hash=stdPwd,vertified=True),
